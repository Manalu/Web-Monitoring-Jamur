...
$excel->getProperties()->setTitle("Data Records Kelembaban Node 1");
...
$sql = "SELECT * FROM reports_kelembaban_node1 ORDER BY id_kelembaban ASC";
...
while( $r = mysqli_fetch_array( $q ) ){
 ...
 $writer->save("Reports_Kelembaban_Node1.xlsx");
 
 header("location:./Reports_Kelembaban_Node1.xlsx");
