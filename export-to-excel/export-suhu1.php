...
$excel->getProperties()->setTitle("Data Records Suhu Node 1");
...
$sql = "SELECT * FROM reports_suhu_node1 ORDER BY id_suhu ASC";
...
while( $r = mysqli_fetch_array( $q ) ){
 ...
 $writer->save("Reports_Suhu_Node1.xlsx");
 
 header("location:./Reports_Suhu_Node1.xlsx");
