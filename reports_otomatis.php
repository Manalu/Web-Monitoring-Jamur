...
<body>
	...
	<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2" >REPORTS MODE OTOMATIS</h1>
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group mr-2">
            <input type="submit" name="export" value="Export" class="btn btn-sm btn-outline-secondary" onclick="window.location = 'export-to-excel/export-otomatis.php';">
          </div>
        </div>
      </div>     
        ...
        <table class="table table-striped table-sm text-center">
            ...
            <tbody>
              <?php
                 ...
                 $sql = "SELECT * FROM reports_mode_otomatis ORDER BY id_mode_otomatis DESC LIMIT $start_from, $limit";  
                 $hasil = mysqli_query($connect,$sql);
                  while ($data = mysqli_fetch_assoc($hasil)){
                      echo "<tr>";
                      echo "<td>".$sno."</td>";        
                      echo "<td>".$data['batas_kelembaban']."</td>";
                      echo "<td>".$data['batas_suhu']."</td>";
      ...
      <?php
        $sql = "SELECT COUNT(id_mode_otomatis) FROM reports_mode_otomatis";  
        ...
        for ($i=1; $i<=$total_pages; $i++) {  
          $pagLink .= "<li class='page-item' ><a href='reports_otomatis.php?page=".$i."'>".$i."</a></li>";  
        };  
        echo $pagLink . "</ul></nav>"; 
  ...
  <script type="text/javascript">
    ...
    $('.pagination').pagination({
        ...
        hrefTextPrefix : 'reports_otomatis.php?page='
        });
      });
    </script>