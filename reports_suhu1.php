...
<body>
	...
	<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      ...
      <h1 class="h2" >REPORTS SUHU NODE 1</h1>
      <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
          <input type="submit" name="export" value="Export" class="btn btn-sm btn-outline-secondary" onclick="window.location = 'export-to-excel/export-suhu1.php';">
        </div>
      </div>
      </div>
      <!-- STATISTIC-->
              ...
              <div class="row">
                  <div class="col-md-6 col-lg-3">
                      <div class="bg-statistic">
                          <h2 class="text-white"><?php echo total_suhu_1() ?></h2>
                          <span class="text-white">Total records</span>
                      </div>
                  </div>
                  <div class="col-md-6 col-lg-3">
                      <div class="bg-statistic">
                          <h2 class="text-white"><?php echo max_suhu_1()."°C"?></h2>
                          <span class="text-white">Suhu Max</span>
                      </div>
                  </div>
                  <div class="col-md-6 col-lg-3">
                      <div class="bg-statistic">
                          <h2 class="text-white"><?php echo min_suhu_1()."°C"?></h2>
                          <span class="text-white">Suhu Min</span>
                      </div>
                  </div>
                  <div class="col-md-6 col-lg-3">
                      <div class="bg-statistic">
                          <h2 class="text-white"><?php echo average_suhu_1()."°C"?></h2>
      ...
      <!-- END STATISTIC-->
        ...
        <table class="table table-striped table-sm text-center">
            ...
            <tbody>
              <?php
                  ...
                  $sql = "SELECT * FROM reports_suhu_node1 ORDER BY id_suhu DESC LIMIT $start_from, $limit";  
        ...
        <?php
          ...
          for ($i=1; $i<=$total_pages; $i++) {  
            $pagLink .= "<li class='page-item' ><a href='reports_suhu1.php?page=".$i."'>".$i."</a></li>";  
          };  
          echo $pagLink . "</ul></nav>"; 
         ?>
      </div>
  ...
  <script type="text/javascript">
    ...
    $('.pagination').pagination({
        ...
        hrefTextPrefix : 'reports_suhu1.php?page='
        });
      });
    </script>