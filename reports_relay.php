...
<body>
	...
	<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      ...
      <h1 class="h2" >REPORTS RELAY</h1>
      <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
          <input type="submit" name="export" value="Export" class="btn btn-sm btn-outline-secondary" onclick="window.location = 'export-to-excel/export-relay.php';">
        </div>
      </div>
      </div>
      ...
      <table class="table table-striped table-sm text-center">
          ...
          <tbody>
            <?php
               ...
               $sql = "SELECT * FROM reports_relay ORDER BY id_reports_relay DESC LIMIT $start_from, $limit";  
      ...
      <?php
        $sql = "SELECT COUNT(id_reports_relay) FROM reports_relay";  
        ...
        for ($i=1; $i<=$total_pages; $i++) {  
          $pagLink .= "<li class='page-item' ><a href='reports_relay.php?page=".$i."'>".$i."</a></li>";  
        };  
        echo $pagLink . "</ul></nav>"; 
       ?>
      </div>
  ...
  <script type="text/javascript">
    ...
    $('.pagination').pagination({
        ...
        hrefTextPrefix : 'reports_relay.php?page='
        });
      });
    </script>